...
describe('Home', () => {
  ...
  it('renders the application description', () => {
    ...
    const descriptions = screen.getAllByText(/This is an application|Opsvision 3 consists of/);
  ...
  it('applies the correct CSS classes', () => {
    ...
    const container = screen.getByRole('heading', { name: /Welcome to Opsvision 3/i }).parentElement;
    expect(container).toHaveClass('hero-banner', 'hero-banner--aqua-emerald');
    
    const headline = screen.getByRole('heading', { name: /Welcome to Opsvision 3/i });
