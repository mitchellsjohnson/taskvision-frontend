...
jest.mock("../mobile-nav-bar-buttons", () => ({
  MobileNavBarButtons: () => (
    <div data-testid="mobile-nav-bar-buttons">Buttons</div>
  ),
}));
...
describe("MobileNavBar", () => {
  ...
  it("renders the mobile navigation bar with initial closed state", () => {
    ...
    expect(
      screen.queryByTestId("mobile-nav-bar-buttons")
  ...
  it("applies the correct CSS classes", () => {
    ...
    const container = screen.getByTestId("mobile-nav-bar-brand").parentElement
      ?.parentElement;
