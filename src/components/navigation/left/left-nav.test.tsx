...
describe("LeftNav", () => {
  ...
  it("renders navigation links with correct paths", () => {
    ...
    expect(screen.getByText("Public").closest("a")).toHaveAttribute("href", "/public");
    expect(screen.getByText("Protected").closest("a")).toHaveAttribute("href", "/protected");
    expect(screen.getByText("Admin").closest("a")).toHaveAttribute("href", "/admin");
    expect(screen.getByText("Admin Features").closest("a")).toHaveAttribute("href", "/admin-features");
  });
